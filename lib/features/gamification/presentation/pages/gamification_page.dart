...
class _GamificationPageState extends State<GamificationPage> {
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              // 2º lugar
              if (top3.length > 1) _buildPodiumPosition(top3[1], 2, 25),
              // 1º lugar
              if (top3.isNotEmpty) _buildPodiumPosition(top3[0], 1, 35),
              // 3º lugar
              if (top3.length > 2) _buildPodiumPosition(top3[2], 3, 15),
            ],
          ),
        ],
      ),
  ...
  Widget _buildPodiumPosition(Map<String, dynamic> member, int position, double height) {
    Color positionColor;

    switch (position) {
      case 1:
        positionColor = const Color(0xFF4A90E2);
        break;
      case 2:
      ...
      case 3:
        ...
        break;
      default:
        positionColor = const Color(0xFF888888);
    }
